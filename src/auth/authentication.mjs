import { createGraphClient, checkAuthStatus } from '../utils/graph-client.mjs';
      ...
      try {
        ...
        if (result.type === 'device_code') {
          ...
          if (info) {
            ...
            message += `The browser should open automatically. If not, go to the URL above and paste the code.\n\n`;
